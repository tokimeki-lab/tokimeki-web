      ...
      <div className="px-0 sm:px-8 text-left text-xs text-gray-500">
        <div>
          <div className="grid gap-6">
            ...
            <div>お客様からお預かりした個人情報は、不正アクセス、紛失、漏えいなどが起こらないよう、慎重かつ適切に管理します。</div>
            ...
            <div className="text-lg font-bold pt-2">5. 個人情報の開示・訂正・削除について</div>
            <div>
            ...
            <div>
              ...
              <Link href="https://marketingplatform.google.com/about/analytics/terms/jp/">Googleアナリティクス利用規約</Link>
              」をご確認ください。
            </div>
            ...
            <div>
              ...
              アドレス、電話番号などの個人情報は含まれません。 従って、Cookieに保存されている情報からお客様個人を特定することはできません。
            </div>
            ...
            <div>
              ...
              アフィリエイトプログラムについて 当サイトは、アフィリエイトプログラムにより商品を紹介しております。
